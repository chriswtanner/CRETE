...
me=`whoami`
hn=`hostname`
baseDir="/home/chris/research/CRETE/"
...
if [ ! -d "${baseDir}src/tree_lstm/data/sick/${num_dirs}/" ]; then
	...
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/train/ecb_doc/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/train/ecb_dirHalf/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/train/ecb_dir/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/dev/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/dev/ecb_doc/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/dev/ecb_dirHalf/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/dev/ecb_dir/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/test/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/test/ecb_doc/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/test/ecb_dirHalf/"
	mkdir "${baseDir}src/tree_lstm/data/sick/${num_dirs}/test/ecb_dir/"
else
